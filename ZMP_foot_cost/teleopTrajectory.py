...
if __name__ == '__main__':
    ...
    test.solve(i_CM, i_dCM, f_CM, f_dCM, TP, step_height, 0.5, 0.0)
    test.solve(i_CM, i_dCM, f_CM, f_dCM, TP, step_height, 0.5, 0.0, True)
    #test.solve(i_CM, i_dCM, f_CM, f_dCM, TP, step_height, 0.5, 0.03, True)
    #test.solve(i_CM, i_dCM, f_CM, f_dCM, TP, step_height, 0.5, 0.06, True)
    #test.plot_solution()
